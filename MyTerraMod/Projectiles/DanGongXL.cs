...
{
    public class DanGongXL : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("dangong");
        }
        ...
        public override void AI()
        {
            ...
            {
                // 如果玩家放弃吟唱就发射弹幕
                Projectile.NewProjectile(projectile.Center, projectile.velocity * 7f, mod.ProjectileType<ShiZiEr>(), (int)(projectile.ai[0] / 200f * 200), 4f, projectile.owner);
                return;
            }
