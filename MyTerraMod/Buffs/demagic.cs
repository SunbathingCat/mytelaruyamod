...
{
    public class demagic : ModBuff
    {
        public override void SetDefaults()
        {
            // 设置buff名字和描述
            DisplayName.SetDefault("反魔法护罩");
            Description.SetDefault("1分钟内免疫一切发射物伤害，再次使用需5分钟蓄能");
        ...
        {
            Lighting.AddLight(player.position, 1.5f, 1.5f, 0.0f);
            // 冒绿光
