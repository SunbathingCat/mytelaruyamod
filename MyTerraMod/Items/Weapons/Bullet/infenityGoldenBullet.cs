...
{
    public class infenityGoldenBullet : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("无限黄金弹");
        ...
        public override void SetDefaults()
        {
            ...
            item.shootSpeed = 4.6f;                  //The speed of the projectile
        ...
        public override void AddRecipes()
        {
            ...
            recipe1.AddIngredient(ItemID.GoldenBullet, 99);
