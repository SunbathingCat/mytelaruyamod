...
namespace MyTerraMod.UI
{
	...
	internal class ExamplePersonUI : UIState
	{
		...
		public override void Update(GameTime gameTime) {
			...
			if (Main.LocalPlayer.talkNPC == -1 || Main.npc[Main.LocalPlayer.talkNPC].type != MyTerraMod.Instance.NPCType("Di Jing")) {
                ...
                MyTerraMod.Instance.ExamplePersonUserInterface.SetState(null);
			}
		}
